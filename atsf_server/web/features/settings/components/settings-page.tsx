...
import type {LatestReleaseInfo, OptionItem, UpdateSelfPayload,} from '@/features/settings/types';
import {
    CodeBlock,
    PrimaryButton,
    ResourceField,
                ...
                <div className='space-y-6'>
                    <div className='grid gap-6 xl:grid-cols-[1.1fr_0.9fr]'>
                        <AppCard
                            ...
                            action={
                                <PrimaryButton type='button' onClick={handleProfileSave}
                        ...
                        <div className='grid gap-6 xl:grid-cols-3'>
                            <div
                                ...
                                <div className='space-y-1'>
                                    <p className='text-base font-semibold text-[var(--foreground-primary)]'>GitHub
                                        账号</p>
                            ...
                            <div
                                ...
                                <PrimaryButton type='button' onClick={handleBindWeChat}
                            ...
                            <div
                                ...
                                <div className='space-y-4'>
                                    ...
                                    <div className='flex flex-wrap gap-2'>
                                        <SecondaryButton type='button' onClick={handleEmailVerification}
                                                         disabled={busyKey === 'email-send'}>
                                            {busyKey === 'email-send' ? '发送中...' : '发送验证码'}
                                        </SecondaryButton>
                                        <PrimaryButton type='button' onClick={handleBindEmail}
                    ...
                    <div className='grid gap-6 xl:grid-cols-[1fr_1fr]'>
                        ...
                        >
                            {bootstrapQuery.isLoading ? (
                                ...
                                <ErrorState title='Discovery Token 加载失败'
                                            description={getErrorMessage(bootstrapQuery.error)}/>
                            ) : (
                                <div className='space-y-4'>
                                    <ResourceField label='Server URL'
                        ...
                        <AppCard title='版本与构建信息' description='用于确认当前前端与后端版本，以及静态导出构建模式。'>
                            <div className='grid gap-4 md:grid-cols-2'>
                                ...
                                <div
                                    ...
                                    <p className='mt-2 text-sm text-[var(--foreground-primary)]'>静态导出 + Go Server
                                        托管</p>
                                </div>
                            </div>
                        </AppCard>
            ...
            <div className='space-y-6'>
                <div className='grid gap-6 xl:grid-cols-[1fr_1fr]'>
                    ...
                    <AppCard
                        ...
                        action={
                            <div className='flex flex-wrap gap-2'>
                                <SecondaryButton type='button' onClick={handleCheckLatestRelease}
